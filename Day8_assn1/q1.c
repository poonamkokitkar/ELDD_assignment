//	Q1. Implement pseudo char device driver that supports multiple device instances. The number of devices given by user while loading module (i.e. moduleparam).
